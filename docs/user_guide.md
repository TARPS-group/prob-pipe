...
| 5 | [External backends](examples/05_external_backends.ipynb) | How `condition_on` dispatches to BlackJAX NUTS (the default), Stan, PyMC, nutpie, and sbijax; pinning a specific method; the inference method registry. |
