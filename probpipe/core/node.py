...
class WorkflowNode(Node):
    ...
    def __init__(
        ...
        *,
        ...
        module: Any | None = None,                  # typically a ModuleNode; kept as Any to avoid import cycles
...
class ModuleNode(Node):
    ...
    def _build_workflows(self):
        ...
        Key change:
          ...
          - WorkflowNode infers needs from signature and resolves from this module at call time.
        """
