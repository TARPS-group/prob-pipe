...
- **Bayesian inference**: `SimpleModel` with NUTS/HMC via TFP + auto-fallback to gradient-free RWMH. `Likelihood` base class. `IterativeForecaster` for sequential Bayesian updating. `MCMCApproximateDistribution` with chain structure and diagnostics.
