...
Core dependencies: JAX and TensorFlow Probability (nightly, [recommended for JAX users](https://github.com/tensorflow/probability/issues/1994#issuecomment-3129033043)).
