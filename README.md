...
You can either use a virtual or conda environment. We have imported many libraries for this code. So, you will also need to satisfy the proper environment to be able to run the code. So, I am sharing my environment details in environment.yml (you can use this file to create a copy of my environment). 
