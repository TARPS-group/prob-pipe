...
class TestArrayRandomFunction:
    ...
    def test_cannot_instantiate_directly(self):
        ...
        with pytest.raises(TypeError, match="abstract"):
            ArrayRandomFunction("f", input_shape=(3,))

    def test_shapes(self):
        rf = _MinimalArrayRF("rf", input_shape=(3,), output_shape=(2,))
        assert rf.input_shape == (3,)
        assert rf.output_shape == (2,)

    def test_default_output_shape(self):
        rf = _MinimalArrayRF("rf", input_shape=(3,))
    ...
    def test_validate_X_scalar_input(self):
        ...
        rf = _MinimalArrayRF("rf", input_shape=())
        dist = rf(jnp.ones(5))
        assert isinstance(dist, Distribution)
    ...
    def test_joint_inputs_accepted_when_supported(self):
        rf = _JointCapableRF("rf", input_shape=(3,))
