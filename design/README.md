...
- **[Part III — Core Abstractions](03-core-abstractions.md)** — the probability domain in dependency order: schemas, values, distributions, kernels, composition, and the hierarchy of distribution kinds, each with a precise contract that must align with the design principles.
